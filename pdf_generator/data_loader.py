...
class DataLoader:
    ...
    def create_seasonal_comparison_plot(self, country_code: str, output_dir: Path) -> Optional[Path]:
        self.load_data()
        
        # Get forecast data
        forecast_data = self.forecast_data[self.forecast_data['isoab'] == country_code]
        forecast_values = {
        ...
        # Create the plot
        months = ['December', 'March', 'September']
        ...
        ax.set_title(f'Seasonal Fatality Comparison - {country_name}', fontsize=14)
        ...
        img_path = output_dir / f"seasonal_comparison_{country_code}.png"
        plt.savefig(img_path, dpi=300, bbox_inches='tight')
        plt.close()
